...
$('body').on('change', "#homepageStatus", function () {
    ...
    $('.loader__').show();
    $.ajax({
        url: "homepage/update-status/" + id + '/' + status,
        method: 'get',
...
$('body').on('change', "#hobbyStatus", function () {
    var id = $(this).attr('data-id');
    if (this.checked) {
        var status = 'active';
    } else {
    ...
    $('.loader__').show();
    $.ajax({
        url: "hobbies/update-status/" + id + '/' + status,
        method: 'get',
        success: function (result) {
            $('.loader__').hide();
        }
...
$('body').on('change', "#serviceStatus", function () {
    ...
    $('.loader__').show();
    $.ajax({
        url: "services/update-status/" + id + '/' + status,
        method: 'get',
        success: function (result) {
            $('.loader__').hide();
        }
...
$('body').on('change', "#participationStatus", function () {
    var id = $(this).attr('data-id');
    if (this.checked) {
        var status = 'active';
    } else {
    ...
    $('.loader__').show();
    $.ajax({
        url: "participations/update-status/" + id + '/' + status,
        method: 'get',
        success: function (result) {
            $('.loader__').hide();
        }
...
$('body').on('change', "#expertiseStatus", function () {
    var id = $(this).attr('data-id');
    if (this.checked) {
        var status = 'active';
    } else {
    ...
    $('.loader__').show();
    $.ajax({
        url: "expertises/update-status/" + id + '/' + status,
        method: 'get',
        success: function (result) {
            $('.loader__').hide();
        }
...
$('body').on('change', "#projectStatus", function () {
    ...
    $('.loader__').show();
    $.ajax({
        url: "projects/update-status/" + id + '/' + status,
        method: 'get',
        success: function (result) {
            $('.loader__').hide();
        }
...
$('body').on('change', "#blogStatus", function () {
    ...
    $('.loader__').show();
    $.ajax({
        url: "blogs/update-status/" + id + '/' + status,
        method: 'get',
        success: function (result) {
            $('.loader__').hide();
        }
